...
def parse_args():
    ...
    parser.add_argument(
        "--config_path", required=True, type=str, help="path to config file"
    )
    parser.add_argument(
        "--output_file",
        type=str,
        default="layers.txt",
        help="path to results file with list of model layers",
    )
    parser.add_argument(
        "--layer_mask",
        nargs="+",
        type=str,
        help="mask to print layer names containing mask. Can be several masks",
    )
