...
class Transformer(Module):
    def __init__(
        ...
        *,
        ...
        init_hyper_conn, *_ = get_init_and_expand_reduce_stream_functions(
        ...
        for i, transformer_block in enumerate(self.layers):
            ...
            if self.use_torch_checkpoint:
                x, next_time_v_residual = checkpoint(
                    time_transformer, x, time_v_residual, use_reentrant=False
                )
            else:
            ...
            if self.use_torch_checkpoint:
                x, next_freq_v_residual = checkpoint(
                    freq_transformer, x, freq_v_residual, use_reentrant=False
                )
            else:
